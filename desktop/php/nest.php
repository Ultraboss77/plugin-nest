    ...
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="local_ip" style="font-size : 1em"></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">{{MAC}}</label>
                <div class="col-sm-2">
                    <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="local_mac" style="font-size : 1em"></span>
                </div>
            </div>
            <div class="type_nest type_protect">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="battery_level" style="font-size : 1em"></span>
                    </div>
                    <label class="col-sm-2 control-label">{{Santé}}</label>
                    <div class="col-sm-1">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="battery_health_state" style="font-size : 1em"></span>
                    </div>
                    <label class="col-sm-2 control-label">{{Remplacer le}}</label>
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="replace_by_date" style="font-size : 1em"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">{{Dernière mise à jour}}</label>
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="last_update" style="font-size : 1em"></span>
                    </div>
                    <label class="col-sm-2 control-label">{{Dernier test}}</label>
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="last_manual_test" style="font-size : 1em"></span>
                    </div>
                </div>
            </div>
            <div class="type_nest type_thermostat">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="wan_ip" style="font-size : 1em"></span>
                    </div>
                    <label class="col-sm-2 control-label">{{Dernier connexion}}</label>
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="last_connection" style="font-size : 1em"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">{{Alimenté}}</label>
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="ac" style="font-size : 1em"></span>
                    </div>
                    <label class="col-sm-2 control-label">{{Batterie}}</label>
                    <div class="col-sm-2">
                        <span class="eqLogicAttr tooltips label label-default" data-l1key="configuration" data-l2key="battery_level" style="font-size : 1em"></span>
